  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-24">
      ...
      <p className="mt-6 max-w-xl text-lg leading-8 text-muted">
        Persoonlijk coach in {site.address.city}, België. Sinds {site.foundedYear}.
      ...
      <div className="mt-14 grid items-start gap-12 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7">
          ...
          <p className="mt-8 max-w-xl text-base leading-7 text-muted">
            Als je gezond en gemotiveerd verder wilt, is het belangrijk om te
            weten wat jij nodig hebt. Voeding, beweging en hoofd samen werken
            beter dan alleen harder trainen. Sinds 2015 verfijn ik die aanpak —
            niet met hype, wel met ritme dat je volhoudt.
          </p>
          <p className="mt-4 max-w-xl text-base leading-7 text-muted">
            Begeleiding kan ter plaatse in Roosdaal, buiten, of online, altijd na
            afspraak.
          </p>
          <p className="mt-4 max-w-xl text-base leading-7 text-muted">
